...
// • If the person is at least 20 years old but less than 65,er print a message that the
//  person is an adult.
// • If the person is age 65 or older, print a message that the person is an eld
